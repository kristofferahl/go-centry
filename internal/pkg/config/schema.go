...
func schemasManifestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schemas/manifest.json", size: 2086, mode: os.FileMode(0644), modTime: time.Unix(1602765815, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0x36, 0x47, 0x7a, 0x54, 0xa7, 0xb7, 0xb7, 0xac, 0xd1, 0x9e, 0x1a, 0xd2, 0xc, 0x8b, 0xc, 0xee, 0xcd, 0x84, 0x9c, 0xb, 0xf6, 0x6f, 0x68, 0xae, 0x7c, 0x87, 0x55, 0xc5, 0xe1, 0xeb, 0xd3, 0xac}}
	return a, nil
}
